            ...
            if (is_array($fieldType)) {
                if ($this->isComplexType($fieldType[0])) {
                    ...
                    if ($elements->length >= 1) {
                        require_once (dirname(__FILE__) . "\\" . str_replace('_', DIRECTORY_SEPARATOR, substr($fieldType[0], strpos($fieldType[0], "_") + 1)) . ".php");
                ...
                if ($this->isComplexType($fieldType)) {
                    $elements = $xpath->query("./a:$fieldName", $dom);
                    if ($elements->length == 1) {
                        require_once (dirname(__FILE__) . "\\" . str_replace('_', DIRECTORY_SEPARATOR, substr($fieldType, strpos($fieldType, "_") + 1)) . ".php");
